...
public class PhysicalActivityController {
	...
	@Operation(summary = "Get all physical activities with pagination")
	@GetMapping(value = "pagination", params = { "page", "size" })
	public List<PhysicalActivity> getAllPaginated(@Validated @RequestParam(value = "page", defaultValue = "0", required = false) int 
	page,
	
	@RequestParam(value = "size", defaultValue = "10", required = false) int pageSize) {
		List<PhysicalActivity> saucer = service.getAll(page, pageSize);
		return saucer;
	}
	...
	public ResponseEntity<?> getByIdActivity(@Validated @PathVariable Integer idActivity) {
	...
	@PostMapping()
	public ResponseEntity<?> createActivity(@Validated @RequestBody PhysicalActivity activity) {
	...
	public ResponseEntity<?> update(@Validated @RequestBody PhysicalActivity physicalActivity, @PathVariable Integer idActivity) {
